<section id="services" class="section bg-light-secondary dark:bg-dark-secondary">
    <div class="container mx-auto ">
        <div class="flex flex-col items-center text-center">
            ...
            <p class="subtitle">
                My web development services begin with a thorough consultation with my clients, where I discuss their
                specific needs and goals for their website. From there, I work closely with them to create a customized
                design that reflects their brand and captures their unique style.
            </p>
        </div>
        <div class="grid md:grid-cols-2 md:gap-4 lg:grid-cols-4 lg:gap-8">
            <div class="bg-light-tail-100 dark:bg-dark-navy-500 p-6 rounded-2xl">
                ...
                <p>
                    create web applications, such as e-commerce sites, content management systems, or social media
                    platforms.
                </p>
            </div>
            <div class="bg-light-tail-100 dark:bg-dark-navy-500 p-6 rounded-2xl">
